...
namespace RealEstateMVC.Controllers
{
    public class MessagesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Content,SentAt,IsRead,SenderId,ReceiverId")] Message message)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Content,SentAt,IsRead,SenderId,ReceiverId")] Message message)
        {
            if (id != message.Id)
            {
                return NotFound();
